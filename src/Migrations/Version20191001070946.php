 ...
 */
final class Version20191001070946 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE hash hash VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE hash hash VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
